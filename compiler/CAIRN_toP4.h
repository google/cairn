#ifndef CAIRN_TOP4_TOP4_H_
#define CAIRN_TOP4_TOP4_H_
...
class ToP4 : public Inspector {
 ...
 public:
    ...
    // statements
    bool preorder(const IR::CAIRNExtractHeaderStatement *s) override;
    bool preorder(const IR::CAIRNMoveStatement *s) override;
